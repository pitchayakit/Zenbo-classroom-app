...
public class Camera2BasicFragment extends Fragment
    ...
    private static String mFileName = "pic.jpg";
    private static String mFileNameTimeStamp;
...
//                }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.picture: {
                ...
                mFileNameTimeStamp = timeStamp+"_"+mFileName;
                break;
            }
            case R.id.info: {
                Activity activity = getActivity();
    ...
    private class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                output.write(bytes);
                new imageHttpPost().execute(mFile.toString());
            } catch (IOException e) {
                e.printStackTrace();
            } finally {
                mImage.close();
    ...
    public class imageHttpPost extends AsyncTask<String, Void, String> {
        @Override
        protected String doInBackground(String... parameters) {
            OkHttpClient client = new OkHttpClient();
            String yourFilePath = parameters[0];
            Log.d(TAG, "imageHttpPost doInBackground: "+ mFileNameTimeStamp);
            ...
            RequestBody body = new MultipartBody.Builder().setType(MultipartBody.FORM)
                    .addFormDataPart("fileToUpload",mFileNameTimeStamp, RequestBody.create(mediaType, file)).build();
